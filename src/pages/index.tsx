                ...
                <div className="flex justify-between items-center">
                    <div className="py-8 md:py-0 md:max-w-xl">
                        ...
                        <div className="flex gap-2 mt-6">
                            <Link href="/contactla" className="inline-flex items-center justify-center whitespace-nowrap rounded-lg border border-transparent bg-blue-500 px-5 py-2 text-base font-medium text-white shadow-sm hover:bg-blue-600">
                                {t('contactla')}
                            </Link>
